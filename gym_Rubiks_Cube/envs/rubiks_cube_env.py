...
class RubiksCubeEnv(gym.Env):
    ...
    def __init__(self, render_mode='rgb_array', order_num=3):
        ...
        self.observation_space = spaces.Box(low, high, dtype=np.float32)  # flattened
        self.step_count = 0
    ...
    def _get_obs(self):
        return np.array([tileDict[i] for i in self.ncube.constructVectorState()], dtype=np.float32)
